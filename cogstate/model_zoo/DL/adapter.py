"""Application extensions of the canonical PyTorch model adapter.

The single-target adapter and seeding implementation live in the top-level
model zoo. Only the streaming-specific masked multitask extension remains here.
"""
