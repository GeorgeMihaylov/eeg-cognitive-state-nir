...
Пример запуска:
    python scripts/data/build_emotiv_pm_windows.py

Быстрый тест:
    python scripts/data/build_emotiv_pm_windows.py --max-records 5

Только gpn_data:
    python scripts/data/build_emotiv_pm_windows.py --source gpn_data

Только Old_EEG:
    python scripts/data/build_emotiv_pm_windows.py --source Old_EEG
"""
