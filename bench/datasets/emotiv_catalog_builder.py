...
Запуск:
    python scripts/data/build_emotiv_catalog.py

Только новые данные:
    python scripts/data/build_emotiv_catalog.py --source gpn_data

Старые и новые:
    python scripts/data/build_emotiv_catalog.py --source all
"""
