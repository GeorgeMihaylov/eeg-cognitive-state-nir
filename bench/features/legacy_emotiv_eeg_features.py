...
Запуск:
    python scripts\\data\\build_legacy_emotiv_features.py

Быстрый тест:
    python scripts\\data\\build_legacy_emotiv_features.py --max-records 5 --output-name windowed_eeg_pm_dataset_w10_test

Только gpn_data:
    python scripts\\data\\build_legacy_emotiv_features.py --source gpn_data

Только Old_EEG:
    python scripts\\data\\build_legacy_emotiv_features.py --source Old_EEG
"""
